<datasources>
	<local-tx-datasource>
		...
		<connection-property name="exceptionInterceptors">${project.packageString}.web.common.${project.projectCode?cap_first}MySQLExceptionInterceptor</connection-property>
