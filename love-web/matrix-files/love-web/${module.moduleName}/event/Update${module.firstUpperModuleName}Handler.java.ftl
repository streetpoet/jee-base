...
@Dependent
public class Update${module.firstUpperModuleName}Handler implements Serializable {
	...
	@LoveTrace
	public void update${module.firstUpperModuleName}(@Observes @Update${module.firstUpperModuleName}EventQualifier Update${module.firstUpperModuleName}Event event){
		
		int result = ${module.moduleName}RemoteBean.update${module.firstUpperModuleName}(${module.moduleName}.clone());
