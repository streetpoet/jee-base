...
@Dependent
public class SampleDeleteEventHandler implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -281137229187993L;
	...
	@LoveTrace
	public void deleteEntity(@Observes @SampleDeleteEventQualifier SampleDeleteEvent event){
		
		int result = sampleRemoteBean.deleteEntity(entity.clone());
