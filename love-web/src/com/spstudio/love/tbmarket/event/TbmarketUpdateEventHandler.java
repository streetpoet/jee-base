...
@Dependent
public class TbmarketUpdateEventHandler implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -80115959082791L;
	...
	@LoveTrace
	public void updateTbAcountBean(@Observes @TbmarketUpdateEventQualifier TbmarketUpdateEvent event){
		
		int result = tbmarketRemoteBean.updateTbAcountBean(tbAcountBean.clone());
